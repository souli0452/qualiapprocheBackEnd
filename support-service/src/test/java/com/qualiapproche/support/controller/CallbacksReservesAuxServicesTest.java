...
import com.qualiapproche.support.controller.internal.SupportInternalCallbackController;
...
class CallbacksReservesAuxServicesTest {
    ...
    void callbacks_reservesAuxServices() {
        PreAuthorize garde = SupportInternalCallbackController.class.getAnnotation(PreAuthorize.class);
        assertThat(garde)
