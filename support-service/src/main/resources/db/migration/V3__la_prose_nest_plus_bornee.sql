--
-- support-service — ce qui se rédige ne se compte plus en caractères.
--
...
ALTER TABLE public.qms_audit_logs ALTER COLUMN details TYPE text;
ALTER TABLE public.qms_demandes_document ALTER COLUMN description TYPE text;
ALTER TABLE public.qms_demandes_document ALTER COLUMN motif_decision TYPE text;
ALTER TABLE public.qms_document_versions ALTER COLUMN comment TYPE text;
ALTER TABLE public.qms_documents ALTER COLUMN description TYPE text;
ALTER TABLE public.qms_workflow_step_templates ALTER COLUMN description TYPE text;
