...
@RequestMapping(NIVEAU_CONFIDENTIALITE_ROOT_URL)
@RequirePermissions(
        create = {"niveau-confidentialite-write", "CONFIG_GLOBAL_MANAGE"},
        update = {"niveau-confidentialite-write", "CONFIG_GLOBAL_MANAGE"},
        read = {"niveau-confidentialite-read", "niveau-confidentialite-write", "document-read", "document-write", "CONFIG_READ"},
        delete = {"niveau-confidentialite-write", "CONFIG_GLOBAL_MANAGE"}
)
public class NiveauConfidentialiteController {
    ...
    private final NiveauConfidentialiteService service;

    @PreAuthorize("@perm.canCreate(this)")
    @PostMapping("/create")
    public ResponseEntity<NiveauConfidentialiteDto> create(@RequestBody NiveauConfidentialiteDto dto) {
        return ResponseEntity.ok(service.create(dto));
    }

    @PreAuthorize("@perm.canUpdate(this)")
    @PutMapping("/update/{id}")
    public ResponseEntity<NiveauConfidentialiteDto> update(@PathVariable("id") UUID id, @RequestBody NiveauConfidentialiteDto dto) {
        dto.setId(id);
    ...
    @PreAuthorize("@perm.canRead(this)")
    @GetMapping("/get/{id}")
    public ResponseEntity<NiveauConfidentialiteDto> getById(@PathVariable("id") UUID id) {
